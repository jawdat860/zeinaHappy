    ...
    <div className="mx-auto max-w-5xl h-full ">
      ...
      <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 h-full">
        <form action="#" className="w-full h-full  rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 lg:max-w-xl lg:p-8">
          ...
          <button type="submit" className="flex w-full items-center bg-black justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Save </button>
        </form>
